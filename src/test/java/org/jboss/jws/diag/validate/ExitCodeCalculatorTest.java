...
public class ExitCodeCalculatorTest {

    @Test
    void shouldReturnOkWhenNoFindingsArePresent() {
        int result = ExitCodeCalculator.determineExitCode(Collections.emptyList());
    ...
    void shouldReturnWarningWhenFindingsContainOnlyWarnings() {
        ...
        int result = ExitCodeCalculator.determineExitCode(findings);
